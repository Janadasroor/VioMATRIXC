...
IFparm VSRCpTable[] = { /* parameters */
 ...
 IOP ("wavefile", VSRC_WAVEFILE, IF_STRING, "WAV file description"),
 IOPR("wave",     VSRC_WAVEFILE, IF_STRING, "WAV file description"),
 IOP ("chan",     VSRC_WAVECHAN, IF_INTEGER, "WAV channel index"),
#ifdef SHARED_MODULE
