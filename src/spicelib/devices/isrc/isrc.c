...
IFparm ISRCpTable[] = { /* parameters */
 ...
 IOP ("wavefile", ISRC_WAVEFILE, IF_STRING, "WAV file description"),
 IOPR("wave",     ISRC_WAVEFILE, IF_STRING, "WAV file description"),
 IOP ("chan",     ISRC_WAVECHAN, IF_INTEGER, "WAV channel index"),
#ifdef SHARED_MODULE
